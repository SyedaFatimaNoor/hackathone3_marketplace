...
async function uploadImageToSanity(imageUrl: string): Promise<string|null> {
  ...
  try {
    ...
    // Debugging: Log the assetd returned by Sanity
    console.log('Image uploaded successfully:', asset);

    return asset._id; //e Return the uploaded image assete reference ID
  } catch (error) {
    ...
    try {
      ...
      for (const product of products) {
        ...
        const sanityProduct = {
          ...
          description: product.description?product.description: "A timeless design, with premium materials features as one of our most popular and iconic pieces. The dandy chair isv perfect for any stylish living space with beech legs and lambskin leather upholstery.",
