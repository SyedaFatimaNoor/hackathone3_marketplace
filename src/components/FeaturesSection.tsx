...
const FeaturesSection = () => {
  ...
  return (
    <section className="py-16 px-8 md:px-16">
      <h2 style={{ fontFamily: 'ClashDisplay' }} className="text-2xl md:text-3xl font-normal text-[#2A254B] mb-12 text-center">
        ...
        {features.map((feature, index) => (
          <div key={index} className="flex flex-col items-start text-left">
            ...
            <div className="w-[266px]">
              <h3 style={{ fontFamily: 'ClashDisplay' }} className="text-lg font-medium text-[#2A254B]">
                {feature.title}
              </h3>
